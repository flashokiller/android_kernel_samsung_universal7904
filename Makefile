...
KBUILD_CFLAGS += -Wno-stringop-overflow -Wno-address-of-packed-member -Wno-switch-unreachable -Wno-zero-length-bounds -Wno-restrict -Wno-sizeof-pointer-div -Wno-nonnull
